...
import { ArrowLeft, Camera, Calendar, MapPin, Tag, Heart, X, Sparkles } from 'lucide-react';
...
// Default memory entries (Replace imageUrls with your own photo paths/URLs!)
const MEMORY_LOGS: MemoryLog[] = [
  {
    ...
    imageUrl: '../../photos/first date in leb',
    tag: 'Milestone',
  ...
  },
  {
    ...
    imageUrl: '../../photos/ana wiyeke w bentna l jahshe',
    tag: 'Field Research',
    caption: 'Having fun',
  ...
  },
  {
    ...
    date: 'Anniversary',
    location: 'Bet ekhtik',
    imageUrl: '../../photos/how i thoughtyou will react',
    tag: 'Celebration',
  ...
  },
  {
    ...
    date: 'Party',
    location: 'Wadina',
    imageUrl: '../../photos/mnhrob mn haflet ma n2argel',
    tag: 'Celebration',
    ...
    id: 'mem-7',
    logNumber: 'LOG-#007',
    title: 'Sunset Baseline Test',
    date: 'Anniversary',
    location: 'The Beach / Coast',
    imageUrl: 'https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=800&auto=format&fit=crop&q=80',
    tag: 'Celebration',
    caption: 'Testing the hypothesis that sunsets are 100x better when watched together.',
          ...
          {MEMORY_LOGS.map((log) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-slate-950">
                ...
                />
                <div className="absolute top-2 left-2 bg-slate-950/80 border border-slate-700 px-2 py-0.5 rounded text-[10px] font-mono text-purple-300">
                  {log.logNumber}
                </div>
              </div>
          ...
          <div className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 z-50">
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-slate-950/80 hover:bg-rose-600 text-white p-2 rounded-full border border-slate-700 z-10 transition-colors cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>

              {/* Modal Image */}
              <div className="relative h-72 md:h-80 bg-slate-950">
                <img
